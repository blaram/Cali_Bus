...
class RouteForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "desc": Textarea(
                attrs={"placeholder": "Ingrese un nombre", "rows": 3, "cols": 3}
            ),
        }
...
class TravelForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "cat": Select(attrs={"class": "select2", "style": "width: 100%"}),
            "departure": DateInput(
                format="%Y-%m-%d",
                attrs={
...
class ParcelItemForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "declared_value": NumberInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Valor declarado",
                }
            ),
            "shipping_cost": NumberInput(
                attrs={
                    "class": "form-control",
    ...
    class Meta:
        ...
        widgets = {
            ...
            "transaction_date": DateInput(
                format="%d-%m-%Y",
                attrs={
                    "valur": datetime.now().strftime("%d-%m-%Y"),
                    "autocomplete": "off",
                    "class": "form-control datetimepicker-input",
                    "id": "transaction_date",
